...
if (matchMedia('(min-width: 640px)').matches) {
   ...
   $(document).ready(function() {
    var videobackground = new $.backgroundVideo($('body'), {
      ...
      "width": 1280,
      "height": 720,
      "path": "http://ak3.picdn.net/shutterstock/videos/3561824/preview/stock-footage-smart-phone-couple-at-night-attractive-young-couple-laugh-as-they-find-content-on-a-smart-phone.mp4",
      "filename": "video",
      "types": ["mp4","ogg","webm"]
    });
  });
